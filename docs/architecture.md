...
| `server/plugins/`               | Plugin subprocess lifecycle and RPC transport; also loads the bundled `plugins/slp` plugin with no config entry (see [docs/plugins.md](../docs/plugins.md#bundled-plugins)) |
...
TanStack Router + Cloudflare Workers. Serves alp.anhlp.com.
