# Adding a Git Forge to alp

alp's forge layer is a registry/manifest system. A forge is a runtime concern:
...
allowlist. Self-hosted detection is a trust gate: alp only talks to a forge
