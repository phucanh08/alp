...
The bundled [alp skill](/docs/skills#alp-alp-reference) instructs agents to check profiles and read their notes before delegating. If none fit, it directs the agent to discover configured providers and models and tell you about the fallback.
