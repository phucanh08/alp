---
title: Why alp?
description: What alp is, what it isn't, and how it fits into your workflow.
nav: Why alp?
order: 2
...
alp is a self-hostable platform for running and orchestrating coding agents. It runs the agent CLIs you already use, on the hardware you already have, and gives you a UI, CLI, and API to drive them from anywhere.
...
- Bring your own. Use your Claude subscription, your OpenAI account, your own API keys, a self-hosted endpoint. alp doesn't proxy model calls.
...
- [alp tools](/docs/orchestration). Agents can drive alp themselves: create isolated workspaces, spawn subagents, open terminals, and send prompts.
- [Hub](/docs/hub). A service you host that starts agents on your daemon when someone mentions you on GitHub, Slack, or Discord.

## What it isn't

Not a hosted agent, not an IDE, not a model provider. alp runs the CLIs you already use and stays out of the way.
