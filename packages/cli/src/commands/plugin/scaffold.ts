  ...
  return (
    <View style={styles.screen}>
      ...
      <Pressable
        ...
        style={styles.button}
        onPress={() => greeting.mutate({ name: "alp" })}
      >
        <Text style={styles.buttonText}>Create greeting</Text>
      </Pressable>
      <Pressable
        accessibilityRole="link"
        accessibilityLabel="Open the alp website"
        style={styles.button}
        onPress={() => openExternal("https://alp.anhlp.com")}
      >
        <Text style={styles.buttonText}>Open alp.anhlp.com</Text>
      </Pressable>
    </View>
  );
}
