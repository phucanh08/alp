...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/phucanh08/alp/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/alp-${normalizedVersion}-arm64.dmg`;
}
