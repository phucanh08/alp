...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree: "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل alp",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ alp ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن alp من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء alp",
      },
      logs: {
        title: "ملف السجل",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من alp ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت alpCLI.",
      },
    },
  },
  rootError: {
    title: "واجه alp مشكلة.",
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "SSH عن بُعد",
      helper: "الاتصال بخادم alp يعمل على المضيف البعيد.",
      fields: {
        target: "مضيف SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع alp",
      ...
      updateRequired: "حدّث المضيف لتمكين التتابع من alp Desktop.",
      unavailable: "عرض الاقتران غير متاح.",
      hint: "قم بمسح رمز QR هذا باستخدام alp على هاتفك، أو انسخ الرابط أدناه.",
      securityWarning:
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم alp الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه alp لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار alp نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه alp",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم alp نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر alp.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث alp على هذا الكمبيوتر",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات alp ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات alp ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق alp من ~/.agents ، ~/.claude ، ~/.codex.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم alp بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم alp بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint: "يدير alp Desktop هذا البرنامج الخفي. حدّث alp Desktop على المضيف.",
          title: "Update daemon",
    ...
    project: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه alp لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
