...
export const ja: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "このワークスペースはalpワークツリーとして作成されていないため、アーカイブはここでは利用できません",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "組み込みデーモンを管理",
        hint: "alpが組み込みデーモンを起動・停止できるようにする",
        pauseTitle: "組み込みデーモンを一時停止",
        pauseMessage:
          "これにより組み込みデーモンが即座に停止します。組み込みデーモンに接続されている実行中のエージェントとターミナルが停止されます。",
        pauseAndStop: "一時停止して停止",
        registrationFailed:
          "組み込みデーモンは起動しましたが、alpがlocalhostの接続を保存できませんでした。デーモン管理をオフにしてから再度オンにするか、localhostを手動で追加してください。",
        pausedStopFailed:
          "組み込みデーモン管理は一時停止されましたが、alpがデーモンを停止できませんでした。",
        updateFailed: "組み込みデーモン管理を更新できません。",
      },
      keepRunning: {
        title: "終了後もデーモンを実行し続ける",
        hint: "alpを終了してもデーモンは実行し続けます",
      },
      logs: {
        title: "ログファイル",
        modalTitle: "デーモンログ",
      ...
      fullStatus: {
        ...
        hint: "`alp daemon status`を実行して出力を表示します",
        view: "ステータスを表示",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon上のRosettaでalpのIntelビルドを実行しています。",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "alp CLIをインストールできません。",
      },
    },
  },
  rootError: {
    title: "alp で問題が発生しました。",
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "リモート SSH",
      helper: "リモートホストで動作する alp デーモンに接続します。",
      fields: {
        target: "SSH ホスト",
      },
      actions: {
    ...
    device: {
      ...
      relayDocs: "リレーの仕組み",
      relayDocsAccessibility: "alp リレーの仕組みを読む",
      enableRelay: "リレーを有効にする",
      enablingRelay: "有効化中...",
      notNow: "今はしない",
      directConnectionHint:
        "リレーを使わない場合は、TCP、Tailscale、または別の VPN で直接接続してください。QR コードは作成されません。",
      updateRequired: "alp Desktop からリレーを有効にするにはホストを更新してください。",
      unavailable: "ペアリングオファーが利用できません。",
      hint: "スマートフォンのalpでこのQRコードをスキャンするか、以下のリンクをコピーしてください。",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "alpを{{count}}回呼び出し",
      other: "alpを{{count}}回呼び出し",
    },
    and: "および",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "alp が通知をオペレーティングシステムに渡しました。",
    ...
    metadataGeneration: {
      ...
      automatic: "自動",
      preferred: "手動",
      automaticHint: "alp が利用可能な高速モデルを選択します",
      preferredHint: "alp が使用するモデルを選択します",
      model: "モデル",
      fallbackHint: "利用できない場合、alp は別の利用可能なモデルを使用します",
      docs: "ドキュメント",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "このコンピューターのalpを更新します",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "alpスキルを更新しますか？",
        updateFallback: "バンドルされたスキルをマシンに同期します。",
        uninstallTitle: "alpスキルをアンインストールしますか？",
        uninstallMessage:
          "~/.agents、~/.claude、~/.codexからすべてのalpオーケストレーションスキルを削除します。",
        choose: "スキルを選択",
        chooseAll: "すべてのスキル",
        chooseAllHint:
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          accessibilityLabel: "alpツールを有効にする",
        },
        systemPrompt: {
          title: "システムプロンプト",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "このホストはオフラインです。alpが自動再接続します。再起動は、ホストがオンラインに戻ってから行ってください。",
          requestFailedTitle: "エラー",
          requestFailedMessage:
            "再起動リクエストの送信に失敗しました。alpは自動的に再接続します。ホストがオンラインになったら再試行してください。",
          dialogFailedMessage: "再起動確認ダイアログを開けませんでした。",
        },
        update: {
          desktopManagedHint:
            "このデーモンはalp Desktopによって管理されています。ホスト上のalp Desktopを更新してください。",
          title: "デーモンを更新",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "alpがプロセスを監督し、$PASEO_PORTを通じてポートを割り当てます",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
      ...
      metadata: {
        title: "メタデータ生成",
        info: "alpがメタデータ生成に使うAIプロンプトへ追加する、プロジェクト固有の指示です。ブランチ名、コミット形式、PR形式など、チームの規約を反映するために使います。",
        branchName: "ブランチ名",
