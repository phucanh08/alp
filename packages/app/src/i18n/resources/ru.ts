...
export const ru: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Архивирование недоступно: это рабочее пространство не было создано как worktree alp.",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Разрешить alp запускать и останавливать встроенный демон",
        ...
        registrationFailed:
          "Встроенный демон запущен, но alp не удалось сохранить подключение к localhost. Выключите и снова включите управление демоном или добавьте localhost вручную.",
        pausedStopFailed:
          "Встроенное управление демоном было приостановлено, но alp не смог остановить демон.",
        updateFailed: "Не удалось изменить настройки управления встроенным демоном.",
      },
      keepRunning: {
        title: "Продолжать работу демона после выхода",
        hint: "Демон продолжит работать после выхода из alp",
      },
      logs: {
        title: "Файл журнала",
    ...
    rosetta: {
      ...
      runningIntel: "Вы используете сборку alp для Intel через Rosetta на Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Не удалось установить alp CLI.",
      },
    },
  },
  rootError: {
    title: "В alp возникла проблема.",
  ...
  pairing: {
    ...
    direct: {
      title: "Прямое подключение",
      helper: "Введите адрес сервера alp.",
      fields: {
        host: "Хост",
        port: "Порт",
        password: "Пароль",
    ...
    remoteSsh: {
      title: "Удалённый SSH",
      helper: "Подключитесь к демону alp на удалённом хосте.",
      fields: {
        target: "Хост SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Узнать, как работает ретранслятор alp",
      ...
      updateRequired: "Обновите хост, чтобы включить ретранслятор из alp Desktop.",
      unavailable: "Данные для сопряжения недоступны.",
      hint: "Отсканируйте этот QR-код с помощью alp на телефоне или скопируйте ссылку ниже.",
      securityWarning:
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "alp передал уведомление операционной системе.",
    ...
    metadataGeneration: {
      ...
      description:
        "Выберите модель, которую alp будет использовать для названий рабочих пространств и веток, сообщений коммитов и черновиков PR",
      selection: "Выбор модели",
      automatic: "Автоматически",
      preferred: "Вручную",
      automaticHint: "alp выбирает быструю доступную модель",
      preferredHint: "Выберите модель, которую использует alp",
      model: "Модель",
      fallbackHint: "Если она недоступна, alp использует другую доступную модель",
      docs: "Документация",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Вкладки браузера в alp используют общие данные входа и данные сайтов.",
    ...
    about: {
      ...
      releaseChannel: {
        label: "Канал выпуска",
        description:
          "Переключитесь на бета-канал, чтобы раньше получать обновления и помогать развивать alp.",
        stable: "Стабильный",
        beta: "Бета",
      },
      updates: {
        ...
        installMessage: "Это обновит alp на этом компьютере.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Обновить навыки alp?",
        updateFallback: "Встроенные навыки будут синхронизированы с этим хостом.",
        uninstallTitle: "Удалить навыки alp?",
        uninstallMessage:
          "Удаляет все навыки оркестрации alp из ~/.agents, ~/.claude и ~/.codex на этом хосте.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Включить инструменты alp",
          hint: "Агенты смогут управлять worktree, агентами и расписаниями.",
          accessibilityLabel: "Добавить инструменты alp",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Этот хост не в сети. alp переподключится автоматически. Дождитесь подключения перед перезапуском.",
          requestFailedTitle: "Ошибка",
          requestFailedMessage:
            "Не удалось отправить запрос на перезапуск. alp переподключается автоматически. Повторите попытку, когда хост появится в сети.",
          dialogFailedMessage: "Не удалось открыть диалог подтверждения перезапуска.",
        },
        update: {
          desktopManagedHint: "Этот демон управляется alp Desktop. Обновите alp Desktop на хосте.",
    ...
    project: {
      ...
      metadata: {
        title: "Генерация метаданных",
        info: "Инструкции для этого проекта, добавляемые в промпты ИИ, с помощью которых alp генерирует метаданные. Используйте их, чтобы соблюдать принятые в команде правила именования веток, оформления коммитов и формата PR.",
