...
export const zhCN: TranslationResources = {
  ...
  composer: {
    slpSeat: {
      lead: "Lead",
      chat: "普通聊天",
      switchToLead: "创建为 Lead",
      switchToChat: "创建为普通聊天",
    },
    placeholders: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree: "此处无法归档，因为此 workspace 不是作为 alp worktree 创建的",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "管理内置 daemon",
        hint: "让 alp 启动和停止内置 daemon",
        pauseTitle: "暂停内置 daemon",
        pauseMessage:
          "这会立即停止内置 daemon。连接到内置 daemon 的运行中 agents 和 terminals 会被停止。",
        pauseAndStop: "暂停并停止",
        registrationFailed:
          "内置 daemon 已启动，但 alp 无法保存 localhost 连接。请关闭后重新开启 daemon 管理，或手动添加 localhost。",
        pausedStopFailed: "内置 daemon 管理已暂停，但 alp 无法停止 daemon。",
        updateFailed: "无法更新内置 daemon 管理设置。",
      },
      keepRunning: {
        title: "退出后保持 daemon 运行",
        hint: "退出 alp 后 daemon 会继续运行",
      },
      logs: {
        title: "日志文件",
      ...
      fullStatus: {
        ...
        hint: "运行 `alp daemon status` 并显示输出",
        view: "查看状态",
        copied: "状态已复制到剪贴板。",
    ...
    rosetta: {
      ...
      runningIntel: "你正在 Apple Silicon 上通过 Rosetta 运行 alp 的 Intel 构建。",
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocs: "中继如何工作",
      relayDocsAccessibility: "阅读 alp 中继的工作原理",
      enableRelay: "启用中继",
      enablingRelay: "正在启用...",
      notNow: "暂不",
      directConnectionHint:
        "不使用中继时，请通过 TCP、Tailscale 或其他 VPN 直接连接。不会生成二维码。",
      updateRequired: "请更新主机，以便从 alp Desktop 启用中继。",
      unavailable: "配对 offer 不可用。",
      hint: "用手机上的 alp 扫描此二维码，或复制下方链接。",
  ...
  settings: {
    ...
    notifications: {
      ...
      sending: "正在发送...",
      sentTitle: "测试通知已发送",
      sentDescription: "alp 已将通知交给操作系统。",
    ...
    metadataGeneration: {
      title: "元数据生成",
      description: "选择 alp 用于工作区标题、分支名称、提交消息和拉取请求草稿的模型",
      selection: "模型选择",
      automatic: "自动",
      preferred: "手动",
      automaticHint: "alp 会选择一个可用的快速模型",
      preferredHint: "选择 alp 使用的模型",
      model: "模型",
      fallbackHint: "如果不可用，alp 会改用其他可用模型",
      docs: "文档",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "浏览器标签页在 alp 中共享登录状态和网站数据。",
        clear: "清除浏览器数据",
        clearing: "正在清除...",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "更新 alp skills？",
        updateFallback: "将内置 skills 同步到你的机器。",
        uninstallTitle: "卸载 alp skills？",
        uninstallMessage: "会从 ~/.agents、~/.claude、~/.codex 移除所有 alp 编排 skills。",
        choose: "选择 skills",
        chooseAll: "全部 skills",
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          accessibilityLabel: "注入 alp tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage: "这个 Host 已离线。alp 会自动重连，请等它恢复在线后再重启。",
          requestFailedTitle: "错误",
          requestFailedMessage: "发送重启请求失败。alp 会自动重连，请在 Host 显示在线后重试。",
          dialogFailedMessage: "无法打开重启确认对话框。",
        },
        update: {
          desktopManagedHint: "此 Daemon 由 alp Desktop 管理。请在 Host 上更新 alp Desktop。",
          title: "Update daemon",
    ...
    project: {
      ...
      metadata: {
        title: "元数据生成",
        info: "注入到 alp 用来生成元数据的 AI prompts 中的 Project 专属指令，可用于强制执行团队约定，例如分支命名、提交风格或 PR 格式",
        branchName: "分支名称",
