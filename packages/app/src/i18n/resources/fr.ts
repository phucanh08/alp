...
export const fr: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travailalp",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Laissezalpdémarrer et arrêter le démon intégré",
        ...
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisalpn'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Daemoncontinue de fonctionner lorsque vous quittezalp",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Exécute`alp daemon status`et affiche la sortie",
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldealpsousRosettasurApple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer lealpCLI.",
      },
    },
  },
  rootError: {
    title: "alp a rencontré un problème.",
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveuralp.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    remoteSsh: {
      title: "SSH distant",
      helper: "Connectez-vous à un daemon alp sur l’hôte distant.",
      fields: {
        target: "Hôte SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais alp",
      ...
      updateRequired: "Mettez à jour l’hôte pour activer le relais depuis alp Desktop.",
      unavailable: "Offre de jumelage indisponible.",
      hint: "Scannez ce codeQRavecalpsur votre téléphone ou copiez le lien ci-dessous.",
      securityWarning:
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "alp a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choisissez le modèle utilisé par alp pour les titres d’espaces de travail, les noms de branches, les messages de commit et les brouillons de pull request",
      selection: "Sélection du modèle",
      automatic: "Automatique",
      preferred: "Manuel",
      automaticHint: "alp choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par alp",
      model: "Modèle",
      fallbackHint: "S’il est indisponible, alp utilise un autre modèle disponible",
      docs: "Documentation",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Les onglets du navigateur partagent les connexions et les données des sites dans alp.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jouralpsur cet ordinateur",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesalp?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesalp?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationalpde ~/.agents, ~/.claude, ~/.codex.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.alpse reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.alpse reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
            "Impossible d'ouvrir la boîte de dialogue de confirmation de redémarrage.",
        },
        update: {
          desktopManagedHint:
            "Ce daemon est géré par alp Desktop. Mettez à jour alp Desktop sur l’hôte.",
          title: "Update daemon",
    ...
    project: {
      ...
      metadata: {
        title: "Génération de métadonnées",
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA quealputilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
