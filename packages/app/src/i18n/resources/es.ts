...
export const es: TranslationResources = {
  ...
  composer: {
    slpSeat: {
      lead: "Lead",
      chat: "Chat normal",
      switchToLead: "Crear como Lead",
      switchToChat: "Crear como chat normal",
    },
    placeholders: {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoalp",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje quealpinicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroalpno pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales dealp",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Ejecuta`alp daemon status`y muestra la salida.",
        view: "Ver estado",
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldealpenRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificaciónalp",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elalpCLI.",
      },
    },
  },
  rootError: {
    title: "alp tuvo un problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidoralp.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conéctate a un daemon de alp en el host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de alp",
      ...
      updateRequired: "Actualice el host para habilitar el relé desde alp Desktop.",
      unavailable: "Oferta de maridaje no disponible.",
      hint: "Escanee este códigoQRconalpen su teléfono o copie el enlace a continuación.",
      securityWarning:
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "alp entregó la notificación al sistema operativo.",
    ...
    metadataGeneration: {
      ...
      description:
        "Elige el modelo que alp usa para títulos de espacios de trabajo, nombres de ramas, mensajes de commit y borradores de pull requests",
      selection: "Selección de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "alp elige un modelo rápido disponible",
      preferredHint: "Elige el modelo que usa alp",
      model: "Modelo",
      fallbackHint: "Si no está disponible, alp usa otro modelo disponible",
      docs: "Documentación",
    ...
    general: {
      ...
      browserData: {
        ...
        description:
          "Las pestañas del navegador comparten inicios de sesión y datos de sitios en alp.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaalpen esta computadora.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades dealp?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesalp?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónalpde ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasalp",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasalp",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.alpse vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.alpse vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
            "No se puede abrir el cuadro de diálogo de confirmación de reinicio.",
        },
        update: {
          desktopManagedHint:
            "Este daemon está administrado por alp Desktop. Actualiza alp Desktop en el host.",
          title: "Update daemon",
    ...
    project: {
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA quealputiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
