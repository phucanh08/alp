export const en = {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let alp start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but alp could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit alp",
      },
      logs: {
        title: "Log file",
      ...
      fullStatus: {
        ...
        hint: "Runs `alp daemon status` and shows the output",
        view: "View status",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of alp under Rosetta on Apple Silicon.",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the alp CLI.",
      },
    },
  },
  rootError: {
    title: "alp ran into a problem.",
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how alp relay works",
      ...
      updateRequired: "Update the host to enable relay from alp Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with alp on your phone, or copy the link below.",
      securityWarning:
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "alp handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model alp uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "alp picks a fast available model",
      preferredHint: "Choose the model alp uses",
      model: "Model",
      fallbackHint: "If it is unavailable, alp falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across alp.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates alp on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update alp skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall alp skills?",
        uninstallMessage:
          "Removes all alp orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. alp reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. alp reconnects automatically-try again once the host shows as online.",
    ...
    project: {
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts alp uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
