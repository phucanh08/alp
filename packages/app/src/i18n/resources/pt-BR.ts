...
export const ptBR: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não foi criado como um worktree do alp",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o alp inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o alp não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o alp não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "O daemon continua em execução quando você sai do alp",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel: "Você está executando a build Intel do alp pelo Rosetta no Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Teste de notificação do alp",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Não foi possível instalar a CLI do alp.",
      },
    },
  },
  rootError: {
    title: "O alp encontrou um problema.",
  ...
  pairing: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor alp.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conecte-se a um daemon alp no host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leia como o relay do alp funciona",
      ...
      updateRequired: "Atualize o host para ativar o relay pelo alp Desktop.",
      unavailable: "Oferta de pareamento indisponível.",
      hint: "Escaneie este QR code com o alp no seu celular ou copie o link abaixo.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "chamou o alp {{count}} vez",
      other: "chamou o alp {{count}} vezes",
    },
    and: "e",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "O alp entregou a notificação ao sistema operacional.",
    ...
    metadataGeneration: {
      ...
      description:
        "Escolha o modelo usado pelo alp para títulos de espaços de trabalho, nomes de branches, mensagens de commit e rascunhos de pull request",
      selection: "Seleção de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "O alp escolhe um modelo rápido disponível",
      preferredHint: "Escolha o modelo que o alp usa",
      model: "Modelo",
      fallbackHint: "Se ele não estiver disponível, o alp usa outro modelo disponível",
      docs: "Documentação",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "As abas do navegador compartilham logins e dados de sites no alp.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Isso atualiza o alp neste computador",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar alp skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar alp skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do alp de ~/.agents, ~/.claude e ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do alp",
          hint: "Agentes poderão gerenciar worktrees, agentes e agendamentos",
          accessibilityLabel: "Injetar ferramentas do alp",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O alp reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O alp reconecta automaticamente. Tente novamente quando o host aparecer como online.",
          dialogFailedMessage: "Não foi possível abrir o diálogo de confirmação de reinício.",
        },
        update: {
          desktopManagedHint:
            "Este daemon é gerenciado pelo alp Desktop. Atualize o alp Desktop no host.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "O alp supervisiona o processo e atribui uma porta via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Geração de metadados",
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o alp usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
