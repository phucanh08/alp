...
export const Route = createFileRoute("/docs/")({
  head: () => {
    ...
    if (!doc)
      return pageMeta(
        "Docs - alp",
        "Install alp and start running coding agents from your phone, desktop, and terminal.",
        "/docs",
      );
    return pageMeta(`${doc.frontmatter.title} - alp Docs`, doc.frontmatter.description, "/docs");
  },
  component: DocsIndex,
});
