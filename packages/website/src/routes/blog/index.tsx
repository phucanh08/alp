...
export const Route = createFileRoute("/blog/")({
  ...
  head: () =>
    pageMeta(
      "Blog – Updates and announcements from the alp team",
      "Product updates, technical posts, and announcements from the alp team. Notes on building a self-hosted, multi-agent dev environment for your phone.",
      "/blog",
    ),
  component: BlogIndex,
});
